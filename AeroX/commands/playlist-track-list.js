...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const createTrackListPage = async (page = 1) => {
            ...
            return { components: [container], flags: MessageFlags.IsPersistent | MessageFlags.IsComponentsV2 };
        };

        await interaction.deferReply();
        const response = await interaction.editReply(await createTrackListPage(1));
